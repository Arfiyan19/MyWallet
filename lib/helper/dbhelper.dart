...
import 'package:myWallet/models/finance.dart';
import 'package:myWallet/constant/finance_type_constants.dart';
...
class DbHelper {
  ...
  void _createDb(Database db, int version) async {
    ...
    await db.insert("user", {'email': 'pian@mail.com', 'password': 'password'});
  }
